			...
			<div class="row clearfix">
				<div class="col-xs-2 column" id="myScrollspy">
					<nav class="bs-docs-sidebar hidden-print hidden-xs hidden-sm affix">
						<ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">
							<li>
								<a href="#section-1" class="editor">寄件流程</a>
							</li>
							<li>
								<a href="#section-2" class="elements">禁寄物品</a>
							</li>
						</ul>
					</nav>
				</div>
				...
				<div class="col-xs-8 column">
					...
					<div class="content">
						...
						<p>因此，消费者在寄递前一定要看清楚关于保险、赔偿、免责等条款。如果是每天快件量较大的客户，建议与申通快递公司另外签订保护自身合法利益的快递合同。
							对于填写运单，要把寄件人与收件人的联系电话、收件人地址填写准确，否则可能会给派送造成麻烦，或在退回快件时找不到退回地址和发件人。</p>
						<h4>2. 贵重物品要购买保险：</h4>
						<p>一般价值2000元以上的物品，如手机
							手表、电脑、照相机、首饰、高档服装、艺术品等建议要购买保险。并在保险货物名称的栏目内上正确的填写物品名称，保险金额、价值，避免理赔时产生纠纷。同时申报价值也需如实填写。有些快递运输保险是有免赔额的，如申报的保险额是5000元，但实际可能只赔4700元，其中有300元是免赔额。</p>
						...
						<h4>4.签收流程：</h4>
						<p>快件外包装完好，由收件人签字确认后验货。如果开箱验货后出现短缺、破损等情况，可以采取退回或让快递业务员写书面材料证明、拍照，并立即打电话通知商家或快递公司客服人员（记住客服人员、快递业务员的姓名或编号）。
						</p>
					...
					<div class="content">
						...
						<h4>二、管制器具</h4>
						<p>
							1．管制刀具：如匕首、三棱刮刀、带有自锁装置的弹簧刀（跳刀）、其他相类似的单刃、双刃、三棱尖刀等。<br> 2．其他：如弩、催泪器、催泪枪、电击器等。
						</p>
						<h4>三、爆炸物品</h4>
						<p>
							1．爆破器材：如炸药、雷管、导火索、导爆索、爆破剂等。<br> 2．烟花爆竹：如烟花、鞭炮、摔炮、拉炮、砸炮、彩药弹等烟花爆竹及黑火药、烟火药、发令纸、引火线等。<br>
							3．其他：如推进剂、发射药、硝化棉、电点火头等。
						</p>
						<h4>四、压缩和液化气体及其容器</h4>
						<p>
							1．易燃气体：如氢气、甲烷、乙烷、丁烷、天然气、液化石油气、乙烯、丙烯、乙炔、打火机等。<br> 2．有毒气体：如一氧化碳、一氧化氮、氯气等。<br>
						...
						<p>
							1．易燃固体：如红磷、硫磺、铝粉、闪光粉、固体酒精、火柴、活性炭等。<br> 2．自燃物质：如黄磷、白磷、硝化纤维（含胶片）、钛粉等。<br>
						...
						<p>
							...
							2．易制毒化学品：如胡椒醛、黄樟素、黄樟油、麻黄素、伪麻黄素、羟亚胺、邻酮、苯乙酸、溴代苯丙酮、醋酸酐、甲苯、丙酮等。<br> 3．吸毒工具：如冰壶等。
						</p>
						...
						<p>
							1．侵犯知识产权：如侵犯专利权、商标权、著作权的图书、音像制品等。<br> 2．假冒伪劣：如假冒伪劣的食品、药品、儿童用品、电子产品、化妆品、纺织品等。
						</p>
						<h4>十七、濒危野生动物及其制品</h4>
						<p>如象牙、虎骨、犀牛角及其制品等。</p>
						<h4>十八、禁止进出境物品</h4>
