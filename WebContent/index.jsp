    ...
    <div class="container">
        <div class="carousel slide carousel-size" id="carousel-871299">
            <ol class="carousel-indicators">
                <li class="active" data-slide-to="0" data-target="#carousel-871299">
                </li>
                <li data-slide-to="1" data-target="#carousel-871299">
                </li>
                <li data-slide-to="2" data-target="#carousel-871299">
                </li>
            </ol>
            ...
            <a class="left carousel-control" href="#carousel-871299" data-slide="prev"><span
                    class="glyphicon glyphicon-chevron-left"></span></a>
            <a class="right carousel-control"
               href="#carousel-871299"
...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="col-md-4 column" style="text-align: center">
            <a class="btn" href="info.html" style="color: black">
                <h2>
        ...
        <div class="col-md-4 column" style="text-align: center">
            <a class="btn" href="warning.html" style="color: black">
                <h2>
        ...
        <div class="col-md-4 column" style="text-align: center">
            <a class="btn" href="login.html" style="color: black">
                <h2>
